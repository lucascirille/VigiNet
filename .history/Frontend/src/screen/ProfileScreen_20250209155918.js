  ...
  const handleLogout = () => {
    Alert.alert(
      ...
      [
        ...
        {
          text: "Aceptar", // Botón para aceptar
          onPress: () => {
            logout(); // Llamar a la función logout del contexto
            navigation.navigate("Splash"); // Redirigir a la pantalla Splash
          },
        },
      ],
      { cancelable: false } // Evita que el usuario cierre el cuadro tocando fuera de él
    );
  }
