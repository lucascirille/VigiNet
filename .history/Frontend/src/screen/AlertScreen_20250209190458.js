...
import { useNotification } from "../context/NotificactionContext"; // Importa el contexto de notificaciones
...
export default function AlertScreen() {
  ...
  const handleAlertPress = (alertLabel) => {
    // Mostrar una notificación con el nombre del botón presionado
